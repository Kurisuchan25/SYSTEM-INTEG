                ...
                if($result) {
                    while($row = mysqli_fetch_assoc($result)) {
                        ...
                        echo '<tr>
                            ...
                            <td>' . $concern . '</td>
                            <td>
                                <button class="btn-update"><a href="update.php?updateid='.$id.'" style="color: white;text-decoration: none;">Update</a></button>
...
<div id="deleteModal" class="modal">
    <div class="modal-content">
        ...
        <button class="btn" onclick="deleteItem()">Yes</button>
