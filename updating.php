...
if(isset($_POST['submit'])){
    ...
    $sql="UPDATE `crud` SET `id`='$id',`name`='$name',`contact`='$contact',`date`='$date',`checkin`='$checkin', `checkout`='$checkout' , `payment`='$payment' WHERE `id`='$id'";
    $result=mysqli_query($con,$sql);
    if($result){
        header('location: displayed_update.php?success=true');
        exit();
    }else{
